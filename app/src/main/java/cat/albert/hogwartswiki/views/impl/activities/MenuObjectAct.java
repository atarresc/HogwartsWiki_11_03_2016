 ...
 */
public class MenuObjectAct extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.objectoptions);
    ...
    public void onClick(View view) {
        Intent intent = new Intent(MenuObjectAct.this, ObjectActivity.class);
